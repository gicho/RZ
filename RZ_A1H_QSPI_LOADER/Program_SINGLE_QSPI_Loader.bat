...
echo ===================================================================
"%BASE%\JLink.exe" -speed 15000 -if JTAG -device R7S721001 -CommanderScript Program_SINGLE_QSPI_Loader.Command
echo ===================================================================
...
echo ===================================================================
echo Error:
echo File "RZ_A1H_QSPI_LOADER.SINGLE.bin" not found
echo ===================================================================
pause
chgclr 07
exit
