...
#define FLASH_CMD_WREN      0x06        // 133 MHz, command is used
#define FLASH_CMD_WRDI      0x04        // 133 MHz, command not used
#define FLASH_CMD_RDID      0x9F        // 133 MHZ, command is used
#define FLASH_CMD_RDSR      0x05        // 133 MHz, command is used        
#define FLASH_CMD_RDCR      0x35        // 133 MHz, command is used
#define FLASH_CMD_WRR       0x01        // 133 MHz  command is used     
#define FLASH_CMD_READ      0x03        //  50 MHz, command not used
#define FLASH_CMD_FTRD      0x0B        // 133 MHz, command not used        
#define FLASH_CMD_PP        0x02        // 133 MHz, command not used
#define FLASH_CMD_4PP       0x12        // 133 MHz, command not used        
#define FLASH_CMD_4QPP      0x34        //  80 MHz, command is used
#define FLASH_CMD_SE        0xD8        // 133 MHz, command not used
#define FLASH_CMD_4SE       0xDC        // 133 MHz, command is used
#define FLASH_CMD_BE        0xC7        // 133 MHz, command is not used
#define FLASH_CMD_RESET     0xF0        // 133 MHz, command is used
...
static inline void SPI_Init()
{
  // SPI CLock Division Rate: 2
  SPIBSC_SPBCR_0_bit.SPBR = 1;
  SPIBSC_SPBCR_0_bit.BRDV = 0;
...
static void CPG_Init(void)
{
  ...
  CPG_FRQCR_bit.IFC = 0;    /* I  Clock = 400.00MHz,                  */
}
