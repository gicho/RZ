...
******************************************************************************/
int32_t R_RIIC_Init(uint32_t channel, uint32_t cks,
		                                          uint32_t brl, uint32_t brh);
int32_t R_RIIC_SendCond(uint32_t channel, uint32_t mode);
int32_t R_RIIC_WriteCond(uint32_t channel, uint32_t mode);
int32_t R_RIIC_WriteSlaveAddr(uint32_t channel, uint16_t addr,
		                                     uint32_t mode, uint32_t addrbit);
