...
void Userdef_SCIF2_UART_Init(uint8_t mode, uint16_t cks, uint8_t scbrr)
{
    ...
    /* Used to suppress the veriable declared but unused warning */
    UNUSED_VARIABLE(dummy_buf);

    /* Module standby clear */
    /* Supply clock to the SCIF(channel 2) */
    RZA_IO_RegWrite_8((uint8_t *)&CPG.STBCR4,
    		          0,
    ...
    {
        /* Transmit FIFO reset */
        RZA_IO_RegWrite_16((uint16_t *)&SCIF2.SCFCR,
        		           1,
    ...
    /* ORER bit clear */
    RZA_IO_RegWrite_16((uint16_t *)&SCIF2.SCLSR,
    		           0,
    ...
    /* Serial control register (SCSCR2) setting */
    /* B'00 : Internal CLK */
    RZA_IO_RegWrite_16((uint16_t *)&SCIF2.SCSCR,
    		           0,
